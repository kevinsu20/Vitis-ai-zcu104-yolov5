...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/VHR-10-split.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/yolov5s_VHR_967.pt', help='model.pt path(s)')
