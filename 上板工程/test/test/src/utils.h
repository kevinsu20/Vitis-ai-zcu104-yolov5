...
#define CONF 0.6
const int classificationCnt = 3;//2
const int anchorCnt = 3;//5
...
void detect(vector<vector<float>>& boxes, vector<float> result, int channel,
  ...
  //vector<float> biases{10,14, 23,27, 37,58,81,82, 135,169, 344,319};
    //vector<float> biases{8,11,18,21,29,62,63,75,105,131,267,248};
    //vector<float> biases{10,13,16,30,33,23,30,61,62,45,59,119,116,90,156,198,373,326};
    //vector<float> biases{50,65,80,150,165,115,150,305,310,225,245,600,595,450,780,991,1860,1630};
    vector<float> biases{5.5
,7
,8
,17
,14
